<template>
    <div class="playList-scroll-container" v-infinite-scroll="load" :infinite-scroll-immediate="false"
...
watchEffect(() => {
    loading.value = true
    props.refresh({ index: pageIndex.value, ...props.params }).then((res: any) => {
