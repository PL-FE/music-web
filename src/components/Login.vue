<template>
    <el-dialog v-model="dialogTableVisible" title="" :width="620" custom-class="login-dialog-conatner">
        <div class="login-container">
            <div class="left-container">
                ...
                <div class="qr-container">
                    <div class="qr-status" v-if="[800, 802].includes(qrStatusCode)">
                        <span class="refresh" @click="loginQrCreateTask" v-if="qrStatusCode === 800">
                            <div>
                                <el-icon class="icon">
                                    <Refresh />
                                </el-icon>
                        ...
                        <span class="wait" v-if="qrStatusCode === 802">
                            <div>
            ...
            <div class="right-container">
                <div class="label">
                    <span @click="loginModel = 0" :class="{ isActive: !loginModel }">
                        密码登陆
                    </span>
                    <el-divider direction="vertical" />
                    <span @click="loginModel = 1" :class="{ isActive: loginModel }">
                        短信登陆
                    </span>
                </div>
                <el-form :model="form" :show-message="false" ref="formRef">
                    ...
                    <div v-if="!loginModel">
                        ...
                        <el-form-item prop="password" required>
                            <el-input v-model="form.password" autocomplete="on" type="password" placeholder="请输入密码">
                    ...
                    <div v-if="loginModel">
                        <el-form-item prop="phone" required :rules="[
                            ...
                            <el-input v-model.number="form.phone" autocomplete="on" placeholder="请输入手机号">
                                <template #prepend>
                                    <el-select v-model="form.countrycode" placeholder="Select" style="width: 82px">
                                ...
                                <template #append>
                                    ...
                                    <el-button v-else @click="hanlderCaptchaSent" :disabled="!!waitCaptchaTime"
                                        :style="{ margin: ' 0 auto', color: '#409eff' }" type="primary" link>
                                        获取验证码
                                    </el-button>
                                </template>
                            </el-input>
...
import { loginByCellphone, loginStatus, loginQrCreate, qrCheck, captchaSent } from '@/api/user'
